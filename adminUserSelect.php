...
$con = mysqli_connect("localhost","oxiago_indika","pRzd1TBbyfr6OzZX4qIPJcCtNM73QD05aW2o","oxiago_indika");
	...
	$result = mysqli_query($con,"SELECT Username FROM namilogindetails");
	while ($row = mysqli_fetch_array($result)){
		$userName =  $row['Username'];
		if($userName!=NULL){
			echo "<p><font size='5'><a class='link_button' href='adminPdfList.php?userInfo=$userName'>" . $userName . "</a>" . "</p>";
		}
	}
